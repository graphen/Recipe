...
import com.szamraj.recipe_app.converter.UnitOfMeasureCommandToUnitOfMeasure;
import com.szamraj.recipe_app.converter.UnitOfMeasureToUnitOfMeasureCommand;
import com.szamraj.recipe_app.model.UnitOfMeasure;
import com.szamraj.recipe_app.repository.RecipeIngredientRepository;
...
public class UnitOfMeasureServiceImpl implements UnitOfMeasureService {
    ...
    public boolean isUnitOfMeasureUsedInRecipes(Long id) {
        return recipeIngredientRepository.existsByUnitOfMeasureId(id);
    }
    
    @Override
    @Transactional(readOnly = true)
    public long getRecipeIngredientCountForUnitOfMeasure(Long id) {
        return recipeIngredientRepository.countByUnitOfMeasureId(id);	
    }
}
